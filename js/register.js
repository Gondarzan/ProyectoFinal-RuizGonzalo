...
const checkUsername = () => {
    ...
    if (isEmpty(username)) {
        ...
        showError(usernameInput, `El nombre debe tener entre ${min} y ${max} caraceres`)
...
const checkPassword = () => {
    ...
    if (isEmpty(password)) {
        showError(passwordInput, 'La contraseña es obligatorio')
    } else if (!isPasswordValid(password)) {
        showError(passwordInput, 'La contraseña debe tener al menso 8 caracteres, una mayuscula, una minuscula y un simbolo.')
    } else {
